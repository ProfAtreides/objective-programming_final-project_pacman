...
{
    std::string pathToFonts = "resources/fonts/";
    std::string pathToModels = "resources/models/";
	...
	font.loadFromFile(pathToFonts + "arial.ttf");
	text.setFillColor(sf::Color::White);
	text.setFont(font);
	text.setCharacterSize(20);
	gracz1Gora.loadFromFile(pathToModels + "Gracz1_gora.png");
	gracz1Prawo.loadFromFile(pathToModels +"Gracz1_prawo.png");
	gracz1Dol.loadFromFile(pathToModels +"Gracz1_dol.png");
	gracz1Lewo.loadFromFile(pathToModels +"Gracz1_lewo.png");
	gracz2Gora.loadFromFile(pathToModels +"Gracz2_gora.png");
	gracz2Prawo.loadFromFile(pathToModels +"Gracz2_prawo.png");
	gracz2Dol.loadFromFile(pathToModels +"Gracz2_dol.png");
	gracz2Lewo.loadFromFile(pathToModels +"Gracz2_lewo.png");
	wzmocnienieTexture.loadFromFile(pathToModels +"wzmocnienie.png");
	sciana.loadFromFile(pathToModels +"sciana.png");
	punktTexture.loadFromFile(pathToModels +"punkt.png");
	gracz1WzmocnienieGora.loadFromFile(pathToModels +"Gracz1_wzmocniony_gora.png");
	gracz1WzmocnieniePrawo.loadFromFile(pathToModels +"Gracz1_wzmocniony_prawo.png");
	gracz1WzmocnienieDol.loadFromFile(pathToModels +"Gracz1_wzmocniony_dol.png");
	gracz1WzmocnienieLewo.loadFromFile(pathToModels +"Gracz1_wzmocniony_lewo.png");
	gracz2WzmocnienieGora.loadFromFile(pathToModels +"Gracz2_wzmocniony_gora.png");
	gracz2WzmocnieniePrawo.loadFromFile(pathToModels +"Gracz2_wzmocniony_prawo.png");
	gracz2WzmocnienieDol.loadFromFile(pathToModels +"Gracz2_wzmocniony_dol.png");
	gracz2WzmocnienieLewo.loadFromFile(pathToModels +"Gracz2_wzmocniony_lewo.png");
	duchTexture.loadFromFile(pathToModels +"Ghost.png");
}
